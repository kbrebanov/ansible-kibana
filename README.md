...
| kibana_i18n_default_locale                       | en                                           | The default locale                                                                                                                                                                                                           |
...
| kibana_server_ssl_certificate                    | ''                                           | Path to the PEM-format SSL certificate file                                                                                                                                                                                  |
| kibana_server_ssl_enabled                        | false                                        | Enable SSL for outgoing requests from the Kibana server to the browser                                                                                                                                                       |
| kibana_server_ssl_key                            | ''                                           | Path to the PEM-format SSL key file                                                                                                                                                                                          |
| kibana_elasticsearch_custom_headers              | {}                                           | Header names and values that are sent to Elasticsearch                                                                                                                                                                       |
...
| kibana_elasticsearch_request_headers_whitelist   | [ authorization ]                            | List of Kibana client-side headers to send to Elasticsearch. To send *no* client-side headers, set this value to [] (an empty list).                                                                                         |
...
| kibana_elasticsearch_ssl_certificate_authorities | ''                                           | Path to the PEM-format SSL client certificate authority file                                                                                                                                                                 |
| kibana_elasticsearch_ssl_certificate             | ''                                           | Path to the PEM-format SSL client certificate file                                                                                                                                                                           |
| kibana_elasticsearch_ssl_key                     | ''                                           | Path to the PEM-format SSL client key file                                                                                                                                                                                   |
| kibana_elasticsearch_ssl_verification_mode       | full                                         | To disregard the validity of SSL certificates, change this setting's value to 'none'                                                                                                                                         |
...
| kibana_kill_on_stop_timeout                      | false                                        | If enabled, then when `stop` is called, if the process has not exited within a reasonable time, SIGKILL will be sent next.                                                                                                   |
| kibana_logging_dest                              | stdout                                       | Enables you specify a file where Kibana stores log output                                                                                                                                                                    |
...
| kibana_pid_file                                  | ''                                           | Specifies the path where Kibana creates the process ID file                                                                                                                                                                  |
